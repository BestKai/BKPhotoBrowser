...
@interface BKPhotoBrowser()<UIScrollViewDelegate,UIGestureRecognizerDelegate,BKPhotoItemViewDelegate,UIActionSheetDelegate>
...
- (void)longPress:(UILongPressGestureRecognizer *)gesture
{
    if (gesture.state == UIGestureRecognizerStateBegan) {
        ...
        BKPhotoItemView *photoItem = [self cellForPage:self.currentPage];
